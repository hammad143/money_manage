  ...
  Widget build(BuildContext context) {
    ...
    return  GestureDetector(
      ...
      child:  AnimatedContainer(
        ...
        padding: widget.isTapped ? EdgeInsets.symmetric(vertical: kDefaultPadding/2.5) :  EdgeInsets.symmetric(vertical: 0 , horizontal: 0),


        width: widget.isTapped ? Responsive.deviceBlockWidth * 80 : Responsive.deviceBlockWidth * 8 ,
